...
## #안녕하세요 6주차 미션 - 나만의 인프런 확장하기 발표 자료 입니다.
### 총 5가지의 기능을 추가 했습니다. 감사합니다.
...
### 기획
- 슬라이드 배너는 자동 넘김으로 각 배너당 5초에 시간을 준다.
- 마우스가 배너에 호버 되면 시간을 멈추고 떠나면 다시 시간이 흐른다.
...
### 기확
- 간단한 Mock-Ai 로 정해진 카테고리 , 키워드 기반 응답을 한다.
- 키워드 => 결제, 환불, 강의 , 수강신청, 쿠폰, 로그인, 수료증, 강사
